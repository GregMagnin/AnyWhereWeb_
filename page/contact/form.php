<div class="container-form">
  ...
  <form action="handler.php" method="post" class="row mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="username" id="field-username" placeholder="Votre nom" value="Nom" class="form-control">
    </div>

    <div class="mb-3">
      <label for="field-email" class="form-label">Email: </label>
      <input type="email" name="email" id="field-email" required placeholder="Votre email" value="TestEmail@gg.com" class="form-control validate">
    </div>
