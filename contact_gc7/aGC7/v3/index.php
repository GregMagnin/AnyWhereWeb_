...
<body>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6Lfs4d8fAAAAAKS-ZkuRGhiM7ST8Vrnes5lYRkhg"></script>
    ...
    <script type="text/javascript">
        $(document).on('submit', '#google_recaptcha_v3', function(e) {
            ...
            grecaptcha.ready(function() {
                grecaptcha.execute('6Lfs4d8fAAAAAKS-ZkuRGhiM7ST8Vrnes5lYRkhg', {
